<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 w-full">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('parent.onboarding.index') }}" 
                   class="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-sky-600 hover:bg-sky-500 text-white text-xs font-bold shadow-sm transition-all">
                    <span class="material-icons text-base">person_add</span>
                    <span>Hubungkan Data Anak</span>
                </a>
                <a href="{{ route('parent.guide') }}" 
                   class="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-white dark:bg-slate-850 border border-slate-200 dark:border-slate-800 text-xs font-bold text-slate-700 dark:text-slate-300 shadow-2xs hover:bg-slate-50 dark:hover:bg-slate-800 transition-all">
    ...
    <div class="space-y-6" x-data="{ activeStudentId: {{ $students->first()?->id ?? 'null' }} }">
        ...
        <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-850 to-sky-950 text-white p-6 sm:p-7 shadow-lg border border-slate-800/80">
            ...
            <div class="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 shrink-0 w-full sm:w-auto">
                    <a href="{{ route('parent.onboarding.index') }}" 
                       class="inline-flex items-center justify-center gap-2 px-4 py-2.5 min-h-[44px] rounded-2xl bg-sky-600 hover:bg-sky-500 text-white text-xs font-extrabold shadow-md shadow-sky-600/30 transition-all transform hover:scale-105 active:scale-95">
                        <span class="material-icons text-base">person_add</span>
        ...
        @empty
            <div class="bg-white dark:bg-slate-900 rounded-3xl p-10 text-center border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
                <div class="w-14 h-14 rounded-3xl bg-sky-100 dark:bg-sky-950 text-sky-600 dark:text-sky-400 mx-auto flex items-center justify-center">
                    <span class="material-icons text-3xl">school</span>
                </div>
                <h3 class="text-base font-extrabold text-slate-900 dark:text-white">Belum Ada Data Siswa Terhubung</h3>
                <p class="text-xs text-slate-500 dark:text-slate-400 max-w-sm mx-auto leading-relaxed">
                    Klik tombol di bawah ini untuk menghubungkan akun Anda dengan data anak Anda yang bersekolah di sini.
                </p>
                <div class="pt-2">
                    <a href="{{ route('parent.onboarding.index') }}" 
                       class="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-sky-600 hover:bg-sky-500 text-white font-extrabold text-xs shadow-lg shadow-sky-600/30 transition-all transform hover:scale-105 active:scale-95">
                        <span class="material-icons text-base">person_add</span>
                        <span>Hubungkan Data Anak Sekarang</span>
                    </a>
                </div>
            </div>
        @endforelse

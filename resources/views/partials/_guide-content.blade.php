<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12" x-data="{ 
    ...
    <div x-show="activeTab === 'all' || activeTab === 'teacher'" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <!-- Card 3: Jurnal & Agenda Mengajar -->
            <div class="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow"
                 x-show="matchesSearch('jurnal mengajar agenda catatan materi kompetensi guru')">
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 border border-emerald-200/60 dark:border-emerald-900">Jurnal Belajar</span>
                    </div>
                    <h3 class="font-bold text-slate-900 dark:text-white text-sm">Pengisian Jurnal & Agenda Kelas</h3>
                    <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                        Tuliskan materi pembelajaran yang diajarkan, capaian/tujuan pembelajaran, serta catatan khusus kejadian di kelas pada setiap sesi jam pelajaran yang selesai.
                    </p>
                    <div class="p-3 bg-slate-50 dark:bg-slate-850 rounded-2xl text-[11px] text-slate-600 dark:text-slate-400 space-y-1.5">
                        <div class="flex items-center gap-1.5 font-semibold text-slate-800 dark:text-slate-200">
                            <span class="material-icons text-xs text-emerald-500">check_circle</span> Manfaat:
                        </div>
                        <ul class="list-disc list-inside space-y-1 pl-1">
                            <li>Rekap otomatis administrasi guru</li>
                            <li>Terdokumentasi rapi untuk supervisi kepala sekolah</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!-- ================= SECTION: PANDUAN ADMIN & OPERATOR ================= -->
    <div x-show="activeTab === 'all' || activeTab === 'admin'" class="space-y-6">
        <div class="flex items-center gap-3 pb-2 border-b border-slate-200/80 dark:border-slate-800">
            ...
            <div>
                <h2 class="text-lg sm:text-xl font-extrabold text-slate-900 dark:text-white">Panduan Administrator & Operator</h2>
                <p class="text-xs text-slate-500 dark:text-slate-400">Manajemen master data, radius GPS sekolah, rekap laporan, persetujuan izin, dan kiosk</p>
            </div>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <!-- Card 1: Manajemen Master Data -->
            <div class="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-3"
                ...
                <div class="flex items-center justify-between">
                    <span class="w-8 h-8 rounded-full bg-sky-100 dark:bg-sky-950 text-sky-600 dark:text-sky-400 font-bold text-xs flex items-center justify-center">1</span>
                ...
                <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                    Admin dapat menambah, mengedit, atau mengimpor data siswa dan guru secara massal via Excel, serta mengatur jadwal pelajaran per semester aktif.
                </p>
            </div>

            <!-- Card 2: Pengaturan Radius GPS & Jam Kerja -->
            <div class="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-3"
                 x-show="matchesSearch('admin pengaturan setting gps radius peta geofencing jam masuk pulang')">
                <div class="flex items-center justify-between">
                    <span class="w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-950 text-emerald-600 dark:text-emerald-400 font-bold text-xs flex items-center justify-center">2</span>
                    <span class="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 border border-emerald-200/60 dark:border-emerald-900">Geofencing & Waktu</span>
                </div>
                <h3 class="font-bold text-slate-900 dark:text-white text-sm">Pengaturan Jam & Radius Lokasi Sekolah</h3>
                <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                    Tentukan titik koordinat sekolah dan batas radius (meter) pada peta interaktif di menu <strong>Pengaturan</strong> agar absensi guru hanya bisa dilakukan di area sekolah.
                </p>
            </div>

            <!-- Card 3: Persetujuan Izin Siswa -->
            <div class="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-3"
                 x-show="matchesSearch('admin persetujuan izin sakit siswa approve reject surat orang tua')">
                <div class="flex items-center justify-between">
                    <span class="w-8 h-8 rounded-full bg-amber-100 dark:bg-amber-950 text-amber-600 dark:text-amber-400 font-bold text-xs flex items-center justify-center">3</span>
                ...
                <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                    Setiap pengajuan izin dari orang tua akan masuk ke menu <strong>Persetujuan Izin</strong>. Admin dapat melihat lampiran surat dokter/foto, lalu menyetujui (Disetujui) atau menolak.
                </p>
            </div>

            <!-- Card 4: Laporan & Rekapitulasi -->
            <div class="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-3"
                ...
                <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                    Unduh laporan kehadiran harian, mingguan, bulanan, atau per semester dalam format Excel/PDF siap cetak untuk pelaporan dinas atau rapat evaluasi sekolah.
                </p>
            </div>
        </div>
    </div>

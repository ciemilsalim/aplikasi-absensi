<x-guest-layout>
    <div class="flex min-h-screen">
        ...
        <div class="relative hidden w-0 flex-1 lg:block">
            {{-- PERBAIKAN: Mengganti link gambar yang rusak dengan yang baru dan relevan --}}
                ...
                <div class="mt-10">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                {{-- Menggunakan komponen Breeze untuk konsistensi --}}
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            @if (Route::has('password.request'))
                                <div class="text-sm">
                                    <a href="{{ route('password.request') }}" class="font-semibold text-sky-600 hover:text-sky-500">Lupa password?</a>
                                </div>
                            @endif
                        </div>

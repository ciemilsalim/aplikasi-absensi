    ...
    <div class="flex min-h-screen">
        ...
        <div class="relative hidden w-0 flex-1 lg:block bg-sky-50 dark:bg-slate-800 overflow-hidden group">
            <div class="absolute inset-0 flex items-center justify-center">
                <img class="absolute inset-0 h-full w-full object-cover transition-transform duration-[6000ms] ease-out group-hover:scale-110" src="{{ asset('images/login-illustration.png?v=2') }}" alt="Ilustrasi siswa SMP sedang presensi">
            </div>

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Pemindai Izin Keluar/Kembali') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white/50 dark:bg-slate-800/50 backdrop-blur-lg p-6 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700">
                ...
                {{-- Tombol Kontrol --}}
                <div id="scanner-controls" class="mt-6">
                ...
                <div id="reader-error" class="text-red-500 text-sm mt-2 text-center hidden"></div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function showResultModal(data, isError) {
                ...
                playSound(isError ? 'error' : 'success'); // Panggil fungsi playSound

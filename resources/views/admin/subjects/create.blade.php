<x-app-layout>
    <x-slot name="header">
        ...
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Tambah Mata Pelajaran Baru</h2>
    </x-slot>
    <div class="py-12">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                         ...
                         <div>
                            ...
                            <textarea id="description" name="description" rows="3" class="block mt-1 w-full border-gray-300 dark:border-slate-700 dark:bg-slate-900 dark:text-gray-300 focus:border-sky-500 dark:focus:border-sky-600 focus:ring-sky-500 dark:focus:ring-sky-600 rounded-md shadow-sm">{{ old('description') }}</textarea>

<x-app-layout>
    <x-slot name="header">
        <x-breadcrumb :breadcrumbs="[
            ...
            ['title' => 'Buat Baru', 'url' => route('admin.announcements.create')]
        ]" />
                ...
                <form action="{{ route('admin.announcements.store') }}" method="POST">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="content" name="content" rows="10" class="block w-full mt-1 border-gray-300 dark:border-slate-700 dark:bg-slate-900 dark:text-gray-300 focus:border-sky-500 rounded-md shadow-sm">{{ old('content') }}</textarea>

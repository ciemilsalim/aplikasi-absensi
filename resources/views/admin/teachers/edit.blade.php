                ...
                <form action="{{ route('admin.teachers.update', $teacher) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            @if($teacher->photo)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $teacher->photo) }}" alt="Foto Guru" class="w-32 h-32 object-cover rounded-md shadow-sm">
                                </div>
                            @endif
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Unggah foto wajah baru untuk mengganti.</p>

            ...
            <div x-data="{ activeTab: 'identitas' }" class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="md:col-span-1">
                    <div class="bg-white dark:bg-slate-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                        <ul class="space-y-1">
                            <li>
                                <button @click="activeTab = 'identitas'" :class="{ 'bg-sky-100 dark:bg-sky-900/50 text-sky-700 dark:text-sky-400': activeTab === 'identitas', 'hover:bg-gray-100 dark:hover:bg-slate-700': activeTab !== 'identitas' }" class="w-full flex items-center gap-3 px-4 py-2 text-left text-sm font-medium rounded-md transition">
                            ...
                            <li>
                                <button @click="activeTab = 'tampilan'" :class="{ 'bg-sky-100 dark:bg-sky-900/50 text-sky-700 dark:text-sky-400': activeTab === 'tampilan', 'hover:bg-gray-100 dark:hover:bg-slate-700': activeTab !== 'tampilan' }" class="w-full flex items-center gap-3 px-4 py-2 text-left text-sm font-medium rounded-md transition">
                             ...
                             <li>
                                <button @click="activeTab = 'absensi'" :class="{ 'bg-sky-100 dark:bg-sky-900/50 text-sky-700 dark:text-sky-400': activeTab === 'absensi', 'hover:bg-gray-100 dark:hover:bg-slate-700': activeTab !== 'absensi' }" class="w-full flex items-center gap-3 px-4 py-2 text-left text-sm font-medium rounded-md transition">

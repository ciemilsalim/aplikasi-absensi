                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-slate-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 hidden md:table-cell">{!! sortable_link('Email', 'email', $sortBy, $sortDirection) !!}</th>
                                    ...
                                    <th scope="col" class="px-6 py-3 hidden lg:table-cell">{!! sortable_link('Terakhir Dilihat', 'last_seen_at', $sortBy, $sortDirection) !!}</th>
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-slate-800 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">
                                        <div>{{ $user->name }}</div>
                                        <div class="text-xs text-slate-500 dark:text-slate-400 font-normal md:hidden">{{ $user->email }}</div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-xs text-gray-500 dark:text-gray-400 hidden lg:table-cell">

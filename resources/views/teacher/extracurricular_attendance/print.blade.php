...
<head>
    ...
    <title>Rekap Kehadiran {{ $extracurricular->name }}</title>
    ...
    <div class="no-print sticky top-0 z-50 bg-slate-900 text-white shadow-xl border-b border-slate-700">
        <div class="max-w-7xl mx-auto px-4 py-3 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            <div class="flex items-center gap-3">
                <a href="{{ route('teacher.extracurricular-attendance.report', array_merge(['extracurricular' => $extracurricular->id], request()->query())) }}" 
                ...
                <div>
                    <h1 class="text-sm font-bold text-white flex items-center gap-2">
                        Dokumen Cetak Rekap Presensi Ekstrakurikuler
                    </h1>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                <button onclick="window.print()" 
                        class="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-white text-xs font-bold shadow-lg shadow-amber-500/30 transition-all cursor-pointer">
        ...
        <div class="break-inside-avoid" style="margin-top: 10px;">
            <div style="font-size: 7.5pt; color: #475569; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px dashed #cbd5e1; padding-bottom: 6px;">
                <div>
                    ...
                    <span style="color: #94a3b8;">- : Tidak Ada Sesi</span>
                </div>
